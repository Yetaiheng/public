...
def main():
    ...
    input_folder = '/home/yth/code/datasets/DIV2K/DIV2K_train_LR_bicubic/X2'  # original image folder
    save_folder = '/home/yth/code/datasets/DIV2K/DIV2K_train_LR_bicubic_sub/X2'  # the created sub-image folder
    n_thread = 20
